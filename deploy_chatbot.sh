...
# # Step 2: Load and Run Llama Model in Ollama
# echo "Loading Llama model in Ollama..."
# docker exec -it ollama ollama pull wangshenzhi/llama3-8b-chinese-chat-ollama-q4
...
# # Step 4: Run the Chatbot Container
# echo "Running chatbot container..."
# docker run -d --name chatbot-app -p 7860:7860 -e EMBED_DEVICE_CHOICE="cpu" chatbot-app
# # docker run -d --name chatbot-app -p 11434:11434 -e EMBED_DEVICE_CHOICE="cpu" chatbot-app
# # docker run -d --name chatbot-app --network="host" -e EMBED_DEVICE_CHOICE="cpu" chatbot-app
